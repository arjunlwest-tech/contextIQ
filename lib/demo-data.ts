...
export const DEMO_EMAILS: Email[] = [
  ...
  { id: "em_05", customer_id: "cust_09", subject: "Ready to scale? Your usage suggests it's time", body: "<p>Hi Jennifer,</p><p>Your team has been using ContextIQ at near-capacity. Let's discuss upgrading...</p>", status: "draft", sent_at: null, opened_at: null, clicked_at: null },
